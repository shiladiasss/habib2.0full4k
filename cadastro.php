...
if ($_POST) {
    ...
    if ($check->fetch()) {
        ...
        $ok = $stmt->execute([
            $_POST['nome'], $cpf_limpo, $_POST['endereco'], $_POST['cep'],
            $_POST['telefone'], $_POST['email'], $_POST['data_nascimento'], $hash
        ]);
        if ($ok) {
...
<div class="box">
    ...
    <form method="post">
        ...
        <input name="senha" type="password" placeholder="Senha (mín. 6)" required minlength="6">
